...
from sklearn.neighbors import KNeighborsClassifier  # Alterado para KNN
...
knn = KNeighborsClassifier(n_neighbors=10)  # Escolhendo 5 vizinhos
...
# Exibe a acurácia
print(f"Acurácia do modelo K-Nearest Neighbors: {accuracy * 100:.2f}%")
